...
<div class="card bg-base-100 shadow-xl">
  <div class="hero rounded-box" style="min-height: 70vh; background-image: url('{{ asset('gedung.jpg') }}');">
      ...
      <div class="hero-content flex min-h-max text-center text-neutral-content mt-30" style="height: 100%">
          <div class="max-w-md">
              ...
              <p class="mb-5 text-base-100">Bergabunglah dengan LKP Dian Cipta Cendikia Kalianda dan tingkatkan keterampilan Anda di bidang yang Anda minati. Kami menawarkan berbagai kursus berkualitas tinggi yang telah terakreditasi dan didukung oleh instruktur berpengalaman. Daftar sekarang dan mulailah perjalanan Anda menuju kesuksesan!</p>
